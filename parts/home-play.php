            ...
            <div class="w-100 p-3 bg-dark">
                ...
                <div class="row g-0 ps-home-play--list">
                    ...
                    <div class="col-12 col-md-3">
                        <a href="<?php echo get_the_permalink($video->ID); ?>" class="d-block bg-cover position-relative text-white" title="<?php echo get_the_title($video->ID); ?>" data-thumb-post="https://img.youtube.com/vi/<?php echo get_field('ps_video_id', $video->ID); ?>/hqdefault.jpg">
