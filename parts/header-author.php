        ...
        <div class="row ps-header-content py-3">
            <div class="col-12 d-flex align-items-center">
                ...
                <div class="text-center flex-grow-1">
                    <h2 class="font-title m-0 ps-header-content--title text-white">
                        <i class="fa-solid fa-at"></i> <?php echo get_the_author_meta('first_name', $obj->data->ID) . ' ' . get_the_author_meta('last_name', $obj->data->ID); ?>
                    </h2>
                </div>
